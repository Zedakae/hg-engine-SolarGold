...
u16 sCherrygroveCityMart[] = {
    ITEM_NET_BALL, ITEM_HEAL_BALL, ITEM_REPEL, ITEM_ELIXIR, ITEM_ORAN_BERRY, 0xFFFF
};

u16 sVioletCityMart[] = {
    ITEM_NET_BALL, ITEM_LEVEL_BALL, ITEM_SUPER_REPEL, ITEM_ELIXIR, ITEM_ORAN_BERRY, ITEM_ESCAPE_ROPE, 0xFFFF
};

u16 sAzaleaCityMart[] = {
    ITEM_NET_BALL, ITEM_LEVEL_BALL, ITEM_MAX_REPEL, ITEM_MAX_ELIXIR, ITEM_ORAN_BERRY, ITEM_ESCAPE_ROPE, ITEM_CHESTO_BERRY, ITEM_PERSIM_BERRY, ITEM_CHERI_BERRY, ITEM_ASPEAR_BERRY, ITEM_RAWST_BERRY, 0xFFFF
};
...
u16 sGoldenrodDepartmentUpper2F[] = {
    ...
    ITEM_REPEL, ITEM_SUPER_REPEL, ITEM_MAX_REPEL, ITEM_ESCAPE_ROPE, 0xFFFF
};
...
u16 sGoldenrodDepartment3F[] = {
    ITEM_FIRE_GEM, ITEM_WATER_GEM, ITEM_ELECTRIC_GEM, ITEM_GRASS_GEM, ITEM_ICE_GEM,
    ITEM_FIGHTING_GEM, ITEM_POISON_GEM, ITEM_GROUND_GEM, ITEM_FLYING_GEM, ITEM_PSYCHIC_GEM,
    ITEM_BUG_GEM, ITEM_ROCK_GEM, ITEM_GHOST_GEM, ITEM_DRAGON_GEM, ITEM_DARK_GEM, ITEM_STEEL_GEM,
    ITEM_NORMAL_GEM, 0xFFFF
};
