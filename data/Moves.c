...
const MoveSourceEntry sMoveSource[NUM_OF_MOVES + 1] = {
    ...
    [MOVE_CAPTIVATE] = {
        ...
        .description = "The foe is charmed into sharply\\nlowering its Sp. Atk stat.",
    },
    ...
    [MOVE_VILE_ENERGY] = {
        .names = {
            .name = "Vile Energy",
            .capsName = "VILE ENERGY",
            .fullName = "Vile Energy",
        },
        .data = {
            .effect = MOVE_EFFECT_LOWER_SP_DEF_HIT,
            .split = SPLIT_SPECIAL,
        ...
        .description = "Conjures a sinister\\nenergy. This may drop\\nthe foes Special\\nDefense.",
    },
